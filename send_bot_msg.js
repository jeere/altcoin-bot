...
var msg = new Discord.MessageEmbed()
  ...
  .addField(
    "Metamask ohjeet",
    "[Click here](https://metamask.io/faqs.html)",
    false
  )
  .addField(
    "Matic bridge ohjeet",
    "[Click here](https://www.youtube.com/playlist?list=PLslsfan1R_z0Epvnqsj29V1LBAh99dzu9)",
    false
  )
  .addField(
    "Binance bridge ohjeet",
    "[Click here](https://binance-wallet.gitbook.io/binance-bridge/guides/binance-bridge-v3)",
    false
  )
  .addField(
    "Yield farming aloittelijan opas",
    "[Click here](https://autofarm.gitbook.io/autofarm-network/how-tos/defi-beginners-guide/beginner-guides/liquidity-mining-and-yield-farming)",
    false
  );
